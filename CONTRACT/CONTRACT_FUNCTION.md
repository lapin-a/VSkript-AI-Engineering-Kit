...
Method는 별도의 Contract에서 정의한다.

---

# 3. Definition

Function은 이름(Name), 입력(Parameter), 반환(Return Type)을 가지는 호출 가능한 계약이다.
...
동일한 Function은 하나의 Function Contract만 가진다.
...
모든 Function Contract는 다음 구조를 따른다.
...
Function Contract는 특정 Runtime 구현에 의존하지 않는다.

동일한 Function Contract는 다양한 Runtime에서 사용할 수 있다.
